...
enum cod_respuesta {
	SET_OK = 200, STORE_OK, SET_ERROR, STORE_ERROR, ERROR_TAMANIO_CLAVE, ERROR_CLAVE_NO_IDENTIFICADA, ERROR_CLAVE_INACCESIBLE, ERROR_CLAVE_NO_TOMADA, ERROR_ESPACIO_INSUFICIENTE,
};
